export const personal = {
  ...
  tagline:
    "Crafting digital experiences that are fast, beautiful, and built to last.",
...
I care deeply about developer experience, code quality, and shipping things that matter.`,
  email: "famartinezal@unal.edu.co",
...
export const projects = [
  {
    ...
    description:
      "Analytics platform with real-time data visualization, custom charts, and team collaboration features. Handles 50K+ daily active users.",
  ...
  },
  {
    ...
    description:
      "High-performance storefront with Stripe payments, inventory management, and a headless CMS. Sub-1s page loads.",
  ...
  },
  {
    ...
    description:
      "Lightweight API gateway with rate limiting, request routing, and observability built-in. Written in Go for maximum performance.",
  ...
  },
  {
    ...
    title: "Nomad CMS",
    description:
      "Minimalist headless CMS for content teams. Markdown-first, git-backed, with a clean editing experience.",
  ...
  },
  {
    ...
    description:
      "Component library and design tokens built for scale. Used across 3 internal products at a startup.",
  ...
  },
  {
    ...
    title: "Whisper CLI",
    description:
      "Terminal tool for summarizing meeting transcripts with AI. Integrates with Notion, Slack, and Google Calendar.",
...
export const experience = [
  {
    company: "Fedearroz - FNA",
    role: "Profesional - 2",
    period: "2013 — Presente",
    description:
      "Procesamiento de imágenes de satélite para obtener las áreas cultivadas en Fedearroz.",
  },
  {
    company: "Vercel",
    ...
    period: "2020 — 2022",
    description:
      "Built and maintained core features of the deployment pipeline and preview environments.",
  },
  {
    company: "Freelance",
    role: "Full Stack Developer",
    period: "2018 — 2020",
    description:
      "Delivered 15+ projects for startups and agencies across Europe.",
  },
];
